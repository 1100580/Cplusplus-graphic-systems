...
void setNavigateSubwindowCamera(camera_t *cam, objecto_t obj)
{
	...
	{
		cam->eye.x = obj.pos.x - 0.005 * cos(modelo.objecto.dir);
		cam->eye.y = obj.pos.y + OBJECTO_ALTURA/2;
		cam->eye.z = obj.pos.z + 0.005 * sin(modelo.objecto.dir);
		center.x = obj.pos.x;
	...
	{
		cam->eye.x = obj.pos.x - 1 * cos(modelo.objecto.dir);
		cam->eye.y = obj.pos.y + .5;
		cam->eye.z = obj.pos.z + 1 * sin(modelo.objecto.dir);
		center.x = obj.pos.x;
		center.y = obj.pos.y + .4;
		center.z = obj.pos.z;
	}
