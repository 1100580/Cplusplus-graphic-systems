...
{
	int x=(int) 0.5+nx+MAZE_HEIGHT/2.0-(1.0-0.5)+2.0;
	int z=(int) (-0.5)+nz+MAZE_HEIGHT/2.0-(1.0-0.5)+2.0;
	printf("X:%d Y:%d\n",z,x);
	if(mazedata[z][x]!='*'){
		 return GL_FALSE;
	}else{
...
void desenhaLabirinto(GLint texID)
{
	glColor3f(1,1,1);
	glPushMatrix();
		glTranslatef(-CHAO_DIMENSAO,0.5,-CHAO_DIMENSAO);
